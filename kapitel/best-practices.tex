...
Prozess verfolgt, dann ist es für ein Unternehmen relative schwer auf
...
so anzupassen, um dieselben Probleme in kürzere Zeit zu lösen. Eine
...
eine Iterationslänge von einem Jahr, kann man jedoch ohne weiteres die Art von
Testen durchführen. Nach Beendigung der Implementierungsphase wird die
...
Monate Zeit, dann wäre es zu aufwendig diesen Prozess jedes Quartal
wiederholen zu müssen. Die Automatisierung einer Regressions-Test-Suite, die
auf \enquote{Knopfdruck} ausgeführt werden kann, hilft dem Unternehmen dabei
...
Iterationslänge nicht zur Verfügung. Da es jetzt kein \enquote{Big Design Up-
Front} geben kann, und das Design kontinuierlich den Gegebenheiten angepasst
werden muss, müssen Softwareentwickler die Technik des \enquote{Refactorings}
...
Muss eine Unternehmen nur einmal im Jahr den potentiellen Endkunden von der
